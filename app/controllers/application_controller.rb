...
class ApplicationController < ActionController::Base
  ...
  def ensure_authenticated_to_facebook 
    ...
    if current_facebook_user == nil
      ...
      self.current_user = User.for(current_facebook_client.access_token, current_facebook_client.expiration, current_facebook_user.id.to_i)
    end
  ...
  def auth_url
    url = authenticator.authorize_url(:scope => 'publish_stream', :display => 'page')
